...
public interface ArticuloManufacturadoMapper {
    ArticuloManufacturadoBaseResponse toBaseResponse(ArticuloManufacturado entity);

    ArticuloManufacturadoFullResponse toFullResponse(ArticuloManufacturado entity);
